...
/**
 * Specialised restore task for the conditional html block
 * (requires encode_content_links in some configdata attrs)
 *
 * TODO: Finish phpdocs
 */
class restore_conditionalhtml_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_conditionalhtml_block_decode_content('block_instances', 'configdata', 'block_instance');
 ...
 */
class restore_conditionalhtml_block_decode_content extends restore_decode_content {
    ...
    protected function get_iterator() {
        ...
        $sql = "SELECT t.id, $fieldslist
                 ...
                 WHERE b.backupid = ?
                   AND b.itemname = ?
                   AND t.blockname = 'conditionalhtml'";
