...
namespace block_conditionalhtml;
...
class search_content_testcase extends \advanced_testcase {
    ...
    /**
     * Creates an conditional HTML block on a course.
     *
     * @param \stdClass $course Course object
     * @return \block_conditionalhtml Block instance object
     */
    protected function create_block($course) {
        $page = self::construct_page($course);
        $page->blocks->add_block_at_end_of_default_region('conditionalhtml');
    ...
    public function test_search_area() {
        ...
        // Create course and add conditional HTML block.
        ...
        $this->assertEquals('conditionalhtml', $area->get_block_name());
        ...
        // Should only be one conditional HTML block systemwide.
