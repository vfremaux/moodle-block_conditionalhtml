...
Feature: conditional HTML blocks in a course
  ...
  Scenario: Adding conditional HTML block in a course
    ...
    And I set the field "conditional HTML block title" to "First block header"
    And I press "Save changes"
    And I add the "HTML" block
    And I configure the "(new conditional HTML block)" block
    And I set the field "Content" to "Second block content"
    And I set the field "conditional HTML block title" to "Second block header"
    And I press "Save changes"
    And I log out
