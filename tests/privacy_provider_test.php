 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_conditionalhtml_privacy_testcase extends \core_privacy\tests\provider_testcase {
    /**
    ...
    public function test_user_block() {
        ...
        // Export the data.
        $this->export_context_data_for_user($user->id, $context, 'block_conditionalhtml');
    ...
    public function test_user_block_unconfigured() {
        ...
        $block = block_instance('conditionalhtml', $block->instance);
    ...
    public function test_get_users_in_context() {
        ...
        $component = 'block_conditionalhtml';
        $title = 'Block title';
    ...
    public function test_delete_data_for_users() {
        ...
        // Create 2 user swith a user context conditional HTML blocks.
        $user1 = $this->getDataGenerator()->create_user();
        $this->setUser($user1);
        ...
        $approvedlist = new approved_userlist($context1, 'block_conditionalhtml', $userlist1->get_userids());
