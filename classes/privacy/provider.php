...
namespace block_conditionalhtml\privacy;
...
/**
 * Privacy Subsystem implementation for block_conditionalhtml.
 *
 * @copyright  2023 Valery Fremaux valery.fremaux@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
        // The block_conditionalhtml block stores user provided data.
        \core_privacy\local\metadata\provider,

        // This plugin is capable of determining which users have data within it.
        \core_privacy\local\request\core_userlist_provider,

        // The block_conditionalhtml block provides data directly to core.
    ...
    public static function get_contexts_for_userid(int $userid) : \core_privacy\local\request\contextlist {
        ...
        $sql = "SELECT c.id
            ...
            INNER JOIN {context} bpc ON bpc.id = b.parentcontextid
                 WHERE b.blockname = 'conditionalhtml'
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $sql = "SELECT bpc.instanceid AS userid
                 ...
                 WHERE bi.blockname = 'conditionalhtml'
                   AND bpc.contextlevel = :contextuser
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($instances as $instance) {
            ...
            $block = block_instance('conditionalhtml', $instance);
            ...
            $html = writer::with_context($context)
                ->rewrite_pluginfile_urls([], 'block_conditionalhtml', 'content', null, $block->config->text);
    ...
    protected static function get_instance_from_context(\context_block $context) {
        ...
        return $DB->get_record('block_instances', ['id' => $context->instanceid, 'blockname' => 'conditionalhtml']);
    }
}
